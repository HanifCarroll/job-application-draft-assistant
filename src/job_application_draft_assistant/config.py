...
class AppPaths:
    ...
    portfolio_root: Path = env_path("JOB_APPLICATION_DRAFT_PORTFOLIO_ROOT", DEFAULT_PORTFOLIO_ROOT)
    ...
    codex_binary: str = os.environ.get("JOB_APPLICATION_DRAFT_CODEX_BINARY", "codex")
    codex_model: str = os.environ.get("JOB_APPLICATION_DRAFT_CODEX_MODEL", "gpt-5.5")
    codex_reasoning_effort: str = os.environ.get("JOB_APPLICATION_DRAFT_CODEX_REASONING_EFFORT", "low")
    codex_timeout_seconds: int = env_int("JOB_APPLICATION_DRAFT_CODEX_TIMEOUT_SECONDS", 180)
    max_workers: int = env_int("JOB_APPLICATION_DRAFT_MAX_WORKERS", 5)
